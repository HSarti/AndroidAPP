...
public class MainActivity extends AppCompatActivity implements BluetoothHelper.BluetoothListener {
    ...
    private static final int SENSOR_TIMEOUT_MS = 10000; // 10 seconds
...
// Soil status with text + background colors
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.action_info) {
            ...
            startActivity(new Intent(this, hwUseApp.class));
            return true;
        } else if (itemId == R.id.action_device) {
            startActivity(new Intent(this, DeviceHelpActivity.class));
            return true;
        } else {
